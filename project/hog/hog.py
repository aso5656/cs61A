...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for _ in range(num_rolls):
        outcome = dice()
        if outcome == special_outcome:
            flag = 1
        else:
            sumof += outcome

    result = flag if flag else sumof
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    score = roll_dice(num_rolls,dice) if num_rolls else free_bacon(opponent_score)
    return score
    # END PROBLEM 3
...
def swine_align(player_score, opponent_score):
    ...
    if player_score*opponent_score:
        a = max(player_score,opponent_score)
        b = min(player_score,opponent_score)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    #getting a local variable [var] reference before assignment error
    #normally not allowed to modify variables defined in parent frames
    ...
    def say(score0,score1):
        ...
        return announce_highest(who, l_score, r)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    highest,num_of_dice =0,1
    for i in range(1,11):
        #对roll_dice求平均值的函数
        average_fuc = make_averaged(roll_dice,trials_count=trials_count)
        #roll_dice(num of dice,dice)
        average_value = average_fuc(i,dice)
        if average_value > highest:
            highest = average_value
            num_of_dice = i
    return num_of_dice
    # END PROBLEM 9
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    num_of_rolls = num_rolls if free_bacon(opponent_score)<cutoff else 0
    return num_of_rolls  # Replace this statement
    # END PROBLEM 10
...
def final_strategy(score, opponent_score):
    ...
    *** extra_turn_strategy to start with ***
    """
    # BEGIN PROBLEM 12
    nor = extra_turn_strategy(score,opponent_score,8,10)



    return nor # Replace this statement
    # END PROBLEM 12
